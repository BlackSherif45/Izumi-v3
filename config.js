...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~KeN9gSVs",
  MENU_URL: process.env.MENU_URL || "https://i.imgur.com/cO0TZJv.jpeg",
  CAPTION: process.env.CAPTION || "Iᴢᴜᴍɪ",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "AGENT",
  BOT_NAME: process.env.BOT_NAME || "MILTON-𝚅3",
  ...
  PROCESSNAME: process.env.PROCESSNAME || "MILTON-v3",
  AUTHOR: process.env.AUTHOR || "MILTON",
